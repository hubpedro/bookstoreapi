...
class UserControllerTest {
   ...
   void testUpdateUser_Success() throws Exception {
       ...
       Mockito.when(this.userService.updateUser(eq(1L), any(UserRequest.class))).thenReturn(updatedResponse);
   ...
   void testPatchUser_Success() throws Exception {
       ...
       Mockito.when(this.userService.patchUser(eq(1L), any(UserRequest.class))).thenReturn(patchedResponse);
